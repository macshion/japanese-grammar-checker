import { API_CONFIG, STORAGE_CONFIG, SYSTEM_PROMPTS } from './config.js';
...
export class ApiService {
    ...
    async getApiKey() {
        return new Promise((resolve) => {
            chrome.storage.local.get([STORAGE_CONFIG.KEYS.API_KEY], (result) => {
                resolve(result[STORAGE_CONFIG.KEYS.API_KEY]);
            });
        });
    }
